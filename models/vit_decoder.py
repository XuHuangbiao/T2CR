...
from ex_model.attention.MobileViTv2Attention import MobileViTv2Attention
import numpy as np
...
class decoder_fuser(nn.Module):
    def __init__(self, dim, num_heads, num_layers):
        ...
        self.sa = MobileViTv2Attention(d_model=64)
        self.conv1 = nn.Conv1d(10, 10, 1, 1, 0, bias=True)
        self.conv2 = nn.Conv1d(10, 10, 1, 1, 0, bias=True)
